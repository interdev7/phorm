...
A MariaDB driver for the [PHORM ORM](https://github.com/interdev7/phorm) — a lightweight, type-safe, driver-agnostic ORM for Dart and Flutter.

## Roadmap

- [ ] MariaDB dialect (`SqlDialect` implementation)
...
```dart
import 'package:phorm_mariadb/phorm_mariadb.dart';

final db = PhormMariadbDatabase(
  host: 'localhost',
  port: 3306,
  database: 'mydb',
  username: 'root',
...
| [phorm_mysql](../phorm_mysql) | 🚧 MySQL driver (in development) |
