...
void main() {
  ...
  group('CHECK constraint name ending in _check', () {
    test(
      'strips the _check suffix when no value matches the constraint',
      () async {
  ...
  group('DB file-backed lifecycle branches', () {
    ...
    test(
      'upgrade re-runs IF NOT EXISTS statements for existing tables',
      () async {
